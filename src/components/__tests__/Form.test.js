...
describe("Form", () => {
  ...
  //   const input = renderedComponent.getByPlaceholderText("Enter Student Name");

  //   fireEvent.change(input, { target: { value: "Jane Doe" } });
  //   fireEvent.click(renderedComponent.getByText("Save"));

  //   expect(onSave).toHaveBeenCalledTimes(1);
  //   expect(onSave).toHaveBeenCalledWith("Jane Doe", null);
  // });
